...
const InputComponent = ({inputTitle,inputId,inputValue,setInputValue}) => {
  ...
  return (
    ...
    <div className="input_element_container relative w-[100%] ">
       <input disabled={inputTitle === 'Email' ? true : false} value={inputTitle === 'Email' ? 'joe@gmail.com' : inputValue} onChange={(e) => setInputValue(e.target.value)}  id={inputId}  onBlur={blurHandler} onFocus={focusHandler}  type={inputTitle === 'Password' ? 'password' : inputTitle === 'Email' ? 'email' : 'text'} className='border outline-none w-[100%] rounded-[4px]  p-[9px]' />
