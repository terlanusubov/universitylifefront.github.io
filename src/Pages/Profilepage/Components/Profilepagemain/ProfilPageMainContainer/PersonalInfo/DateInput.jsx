...
const InputComponent = ({inputTitle}) => { 
  ...
  return (
    <div className='profile_detail_input relative max-w-[360px] w-[100%] '>
        ...
        <label className={`select-none input_text absolute   rounded-[2px] bg-white translate-y-[-50%] ease-out text-gray-500 duration-[.35s] px-[4px] text-[13.5px] left-[10px] top-0`}>{inputTitle}<span className='absolute  bottom-[3px] text-red-400'>*</span> </label>
    </div>
  )
}
