...
const Countdata = () => {
  ...
  return (
    ...
    <div className="w-[100%] mx-auto max-w-[1440px] justify-items-center main_page_count_data py-[30px]   grid grid-cols-4 max-[920px]:grid-cols-2 grid-rows-1 max-[920px]:grid-rows-2 ">
