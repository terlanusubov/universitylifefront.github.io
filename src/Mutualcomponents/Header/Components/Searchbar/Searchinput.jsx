...
const Searchinput = () => {
  ...
  return (
    <div className={`search_input_container   ${state ? 'hidden' : 'block  '} relative`}>
        <input type="text" onFocus={(e) => focusHandler()} className={`border-[1.4px] border-solid  border-gray-300 rounded-[6px] pl-[33px] outline-none py-[10px] w-[100%] placeholder:text-[14px] max-w-[400px]`} placeholder='Search by City, University or Property' />
