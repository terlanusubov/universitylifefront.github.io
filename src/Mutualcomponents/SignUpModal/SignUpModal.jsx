      ...
      <div className='modal-overlay'>
        < div className='login-signup' >
          ...
          <form action="/" onSubmit={RegisterHandler} className={toggle === 1 ? "show-content" : "content"} >
            ...
            <button onSubmit={RegisterHandler} type="submit" className='login bg-customOrange'>{loading ? 
...
<div  role="status">
 ...
 : 'Register'}</button>
          ...
          <form action="/" className={toggle === 2 ? "show-content" : "content"}>
            ...
            <div className="input_container">
              <input  onFocus={focusHanlder} onBlur={blurHandler} type="password" id='pwd' name='pwd' className=' border rounded-[10px] p-[10px]' />
              <span className='text-white'>Password</span>
            </div>
